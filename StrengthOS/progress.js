// progress.js - Lógica de Gráficas de Progreso Mensual del Atleta
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function initMonthlyStats() {
        ...
        select.onchange = (e) => renderMonthlyStats(e.target.value);
        ...
        if (monthsArr.length > 0) {
            ...
            document.getElementById("monthly-stats-container").innerHTML =
                `<div style="text-align:center;padding:40px;color:var(--text-tertiary);">
                    <p>Aún no has registrado progreso en ningún entrenamiento.</p>
                    <p style="font-size:0.85rem;margin-top:8px;">Ve a <a href="calendar.html" style="color:var(--primary-300);">Mis Entrenos</a> y registra tus series.</p>
                </div>`;
        }
    }
    ...
    function renderMonthlyStats(monthFilter) {
        ...
        exercises.forEach(ej => {
            ...
            const colorsReps = dataReps.map((val, index) => {
                ...
                const repsDiff = val - dataReps[index - 1];
                const weightDiff = (dataWeights[index] || 0) - (dataWeights[index - 1] || 0);
                        ...
                        tooltip: {
                            ...
                            callbacks: {
                                afterLabel: function (context) {
                                    ...
                                    let weightText = (allSame && wArr[0] !== "-") ? `${wArr[0]}` : `[ ${record.weightString} ]`;
                                    return [
